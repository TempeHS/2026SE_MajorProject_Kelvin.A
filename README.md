...
- **Last increment:** `DamageText` class is implemented, damage visually shows as floating up then dissapearing, same applies to healing

- **Next planned increment:** Add hurt/defence options
