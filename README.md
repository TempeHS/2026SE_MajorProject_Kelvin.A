...
- **Last increment:** Hurt and death animations implemented, game has an overlay when the player dies
  
- **Next planned increment:** Add a defend option as an input, run action is dropped
