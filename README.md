...
- **Last increment:** Defend mode added for enemies and players, 3 different defence options

- **Next planned increment:** Implement a turn indicator, create a database to capture game end statistics
